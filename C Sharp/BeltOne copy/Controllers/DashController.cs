    ...
    public class DashController : Controller
    {
        ...
        public IActionResult Dashboard()
        {
            ...
            List<User> AllUsers = _context.Users
                .OrderBy(u => u.UserId)
                .ToList();
            List<Friend> AllFriends = _context.Friends.Where( f => f.AssociatedFriend == CurrentUser.UserId);
        ...
        [HttpPost]
        [Route("AddFriend")]
        public IActionResult AddFriend(InvitationValidation NewInvitation)
        {
            Invitation Data = NewInvitation.ToInvitation();
        ...
        // {
        //     User CurrentUser = _context.Users.Where(u => u.UserId == (int)HttpContext.Session.GetInt32("UserId")).SingleOrDefault();
        //     List<Friend> AllFriends = _context.Friends
